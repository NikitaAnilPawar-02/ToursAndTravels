...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Rajasthan</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/rajasthan2.jpg" class="img-fluid text" alt="Rajasthan">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Rajasthan</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">8 Days 7 Hotel Nights</h4>
                  <p><b>Rajasthan: Ranthambore 1N, Jaipur 2N, Pushkar 1N, Chitthorgarh, Udaipur 3N, Nathdwara</b></p>
                  <hr>
                  <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                              ...
                              <tbody>
                                    <tr>
                                          <td>RANATHAMBORE</td>
                                          <td>RANTHAMBHORE NATIONAL RESORT</td>
                                          <td>1</td>
                                    </tr>
                              </tbody>
                              <tbody>
                              ...
                              <tbody>
                                    <tr>
                                          <td>UDAIPUR</td>
                                          <td>HOWARD JOHNSON BY WYNDHAM</td>
                                          <td>3</td>
                                    </tr>
                              </tbody>
                        </table>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_rajasthan.php" method="post" class="p-2">
                                    ...
                                    <div class="input-group mb-3">
                                          ...
                                          <select name="Transport" class="form-select border border-secondary" required>
                                                ...
                                                <option value="Car(3 PASSENGER)">Car(3 PASSENGER) ₹3500
                                                      per day</option>
                                                <option value="Small Coach(4-8 PASSENGER)">Small Coach(4-8
                                                      PASSENGER) ₹4500 per day</option>
                                                <option value="Coach(8-15 PASSENGER)">Coach(8-15
                                                      PASSENGER) ₹8000 per day</option>
                                                <option value="Large Coach(15-25 PASSENGER)">Large
                                                      Coach(15-25 PASSENGER) ₹10000 per day</option>
                                          </select>
                                    ...
                                    <input type="hidden" name="Package" value="Rajasthan">
