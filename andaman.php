...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Andaman</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/Andaman2.jpg" class="img-fluid text" alt="Andaman">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Andaman</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">7 Days 6 Hotel Nights</h4>

                  <p><b>Andaman: Port Blair 3N, Netaji Subhas Chandra Bose Dweep (Ross Island), Swaraj Dweep (Havelock)
                              2N, Shaheed Dweep (Neil Island) 1N</b></p>
                  <hr>
                        ...
                        <table class="table table-bordered">
                              ...
                              <tbody>
                                    <tr>
                                          ...
                                          <td>SILVER SAND VILLAGE - HAVELOCK</td>
                                          <td>2</td>
                                    </tr>
                              </tbody>
                              <tbody>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_andaman.php" method="post" class="p-2">
                                    ...
                                    <div class="input-group mb-3">
                                          ...
                                          <select name="Transport" class="form-select border border-secondary" required>
                                                ...
                                                <option value="Car(3 PASSENGER)">Car(3 PASSENGER) ₹8500
                                                      per day</option>
                                                <option value="Small Coach(4-8 PASSENGER)">Small Coach(4-8
                                                      PASSENGER) ₹9500 per day</option>
                                                <option value="Coach(8-15 PASSENGER)">Coach(8-15
                                                      PASSENGER) ₹13000 per day</option>
                                                <option value="Large Coach(15-25 PASSENGER)">Large
                                                      Coach(15-25 PASSENGER) ₹15000 per day</option>
                                          </select>
                                    ...
                                    <input type="hidden" name="Package" value="Andaman">
