...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Himachal</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/Himachal2.jpg" class="img-fluid text" alt="Himachal">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Himachal</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">9 Days 8 Hotel Nights</h4>

                  <p><b>Himachal Pradesh: Shimla 2N, Kufri, Kullu, Manali 4N, Solang, Rohtang Snow Point. Punjab: Chandigarh 2N, Pinjore</b></p>
                  <hr>
                  ...
                  <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                              ...
                              <tbody>
                                    <tr>
                                          <td>SHIMLA</td>
                                          <td>EAST BOURNE PINE FOREST RESORT</td>
                                          <td>2</td>
                                    </tr>
                              </tbody>
                              <tbody>
                        ...
                        <p class="text-danger">Note : Under unavoidable circumtances Hotels are subject to change,
                              in such condition
                              substitute hotel of similar category is provided.</p>
                  </div>
                  <hr>
            </div>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_himachal.php" method="post" class="p-2">
                                          ...
                                          <div class="col-md-6 mb-3">
                                                <div class="input-group">
                                                      ...
                                                      <input type="text" class="form-control border border-secondary"
                                                            name="NoOfDays" value="9 Days" readonly>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="input-group mb-3">
                                          ...
                                          <select name="Transport" class="form-select border border-secondary" required>
                                                ...
                                                <option value="Car(3 PASSENGER)">Car(3 PASSENGER) ₹6500
                                                      per day</option>
                                                <option value="Small Coach(4-8 PASSENGER)">Small Coach(4-8
                                                      PASSENGER) ₹7500 per day</option>
                                                <option value="Coach(8-15 PASSENGER)">Coach(8-15
                                                      PASSENGER) ₹11000 per day</option>
                                                <option value="Large Coach(15-25 PASSENGER)">Large
                                                      Coach(15-25 PASSENGER) ₹13000 per day</option>
                                          </select>
                                    ...
                                    <input type="hidden" name="Package" value="Himachal">
