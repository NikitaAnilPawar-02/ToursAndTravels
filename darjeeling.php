...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Darjeeling</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/Darjeeling2.jpg" class="img-fluid text" alt="Darjeeling">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Darjeeling</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">7 Days 6 Hotel Nights</h4>
                  <p><b>Sikkim: Gangtok 3N, West Bengal: Darjeeling 3N</b></p>
                  <hr>
                  ...
                  <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                              ...
                              <tbody>
                                    <tr>
                                          <td>GANGTOK</td>
                                          <td>DAKSHA TARAYANA GRAND HOTEL</td>
                                          <td>3</td>
                                    </tr>
                              </tbody>
                              <tbody>
                                    <tr>
                                          <td>DARJEELING</td>
                                          <td>PINE TREE RESORT & SPA,DARJEEL</td>
                                          <td>3</td>
                                    </tr>
                              </tbody>
                        </table>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_darjeeling.php" method="post" class="p-2">
                                          ...
                                          <div class="col-md-6 mb-3">
                                                <div class="input-group">
                                                      ...
                                                      <input type="text" class="form-control border border-secondary"
                                                            name="NoOfDays" value="7 Days" readonly>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="input-group mb-3">
                                          ...
                                          <select name="Meal" class="form-select border border-secondary" required>
                                                ...
                                                <option value="Full Board (Breakfast, Lunch, Dinner)">Full
                                                      Board (Breakfast, Lunch, Dinner)</option>
                                                <option value="Half Board (Breakfast and One Meal)">Half
                                                      Board (Breakfast and One Meal)</option>
                                                <option value="All-Inclusive (All Meals and Snacks)">
                                                      All-Inclusive (All Meals and Snacks)</option>
                                          </select>
                                    </div>
                                    <input type="hidden" name="Package" value="Darjeeling">
