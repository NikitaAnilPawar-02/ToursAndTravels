...
$mealCosts = [
    'Full Board (Breakfast, Lunch, Dinner)' => 1000,
    'Half Board (Breakfast and One Meal)' => 500,
    'All-Inclusive (All Meals and Snacks)' => 1500,
];
...
if (isset($_POST['Submit'])) 
{
    ...
    $totalTransportationCost = $transportationCosts[$Transport] * 13; 
    $totalMealCost = $mealCosts[$Meal] * $NoOfPeople * 13; 
