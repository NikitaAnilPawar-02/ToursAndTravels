...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Kashmir</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/Kashmir2.jpg" class="img-fluid text" alt="Kashmir">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Kashmir</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">8 Days 7 Hotel Nights</h4>
                  <p><b>Jammu & Kashmir: Srinagar 4N (Houseboat 1N, Hotel 3N), Sonmarg, Gulmarg, Khilanmarg (Affarwat), Pahalgam 1N, Chandanwari, Katra 2N, Vaishnodevi.</b></p>
                  <hr>
                  <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                              ...
                              <tbody>
                                    <tr>
                                          <td>SRINAGAR</td>
                                          <td>WANGNOO HERITAGE HOUSEBOAT</td>
                                          <td>1</td>
                                    </tr>
                              </tbody>
                              <tbody>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_kashmir.php" method="post" class="p-2">
                                    ...
                                    <div class="input-group mb-3">
                                          ...
                                          <select name="Transport" class="form-select border border-secondary" required>
                                                ...
                                                <option value="Car(3 PASSENGER)">Car(3 PASSENGER) ₹7500
                                                      per day</option>
                                                <option value="Small Coach(4-8 PASSENGER)">Small Coach(4-8
                                                      PASSENGER) ₹8500 per day</option>
                                                <option value="Coach(8-15 PASSENGER)">Coach(8-15
                                                      PASSENGER) ₹12000 per day</option>
                                                <option value="Large Coach(15-25 PASSENGER)">Large
                                                      Coach(15-25 PASSENGER) ₹14000 per day</option>
                                          </select>
                                    ...
                                    <input type="hidden" name="Package" value="Kashmir">
