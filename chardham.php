...
<html lang="en">
      ...
      <head>
            ...
            <title>ExploreXperts - Chardham</title>
      </head>
      ...
      <body>
            ...
            <!----------information------------->
            <img src="Photos/chardham2.jpg" class="img-fluid text" alt="Chardham">
            <div class="text-center mt-3">
                  <h1 class="title text-uppercase">Chardham</h1>
            </div>
            <div class="container">
                  <h4 class="mt-4 text-primary">13 Days 12 Hotel Nights</h4>

                  <p><b>Uttarakhand: Haridwar 2N, Sayanachatti 2N, Yamunotri, Uttarkashi 2N, Gangotri, Sitapur 3N,
                              Kedarnath, Gauri Kund, Pipalkoti 1N, Badrinath 1N, Kirtinagar 1N, Rishikesh.</b></p>
                  <hr>
                  ...
                  <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-10 border shadow rounded-4 p-5">
                              <h1 class="mb-4 text-center text-light rounded-3 fw-bold"
                                    ...
                                    TOUR</h1>
                              <form action="calculate_price_chardham.php" method="post" class="p-2">
                                          ...
                                          <div class="col-md-6 mb-3">
                                                <div class="input-group">
                                                      ...
                                                      <input type="text" class="form-control border border-secondary"
                                                            name="NoOfDays" value="13 Days" readonly>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <input type="hidden" name="Package" value="Chardham">
